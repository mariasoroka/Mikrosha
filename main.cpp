...
using namespace std;
enum types_of_input_output_changes: short {no_change, input_changed, output_changed, output_and_input_changed};
            ...
            for (int j = 0; j < number_of_commands_in_conveyor; j++) {
                ...
                if (command_word != "exit" && command_word != "cd" && command_word != "pwd" && command_word != "time") {
                    ...
                    if (pid == 0) {
                        ...
                        if (j == 0 && number_of_commands_in_conveyor != 1) {//закрываем все дескрипторы, кроме двух
                    ...
                    if (pid == 0) {
                        ...
                        //                cout << times.real << " " << times.user << " " << times.sys << "\n";
